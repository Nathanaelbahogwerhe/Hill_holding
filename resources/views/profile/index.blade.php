                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @foreach($user->roles as $role)
                                <span class="px-3 py-1 rounded-lg bg-gradient-to-r from-purple-600/30 to-purple-700/30 border border-purple-500/50 text-purple-300 text-xs font-semibold">
                                    {{ $role->name }}
                                </span>
                            @endforeach
                        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-neutral-800/50 rounded-xl p-4 border border-neutral-700 hover:border-[#D4AF37]/30 transition-colors">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div class="p-2 bg-gradient-to-r from-[#D4AF37] to-yellow-500 rounded-lg">
                    ...
                    <div class="bg-neutral-800/50 rounded-xl p-4 border border-neutral-700 hover:border-[#D4AF37]/30 transition-colors">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="px-3 py-1 rounded-lg bg-gradient-to-r from-green-500/20 to-green-600/20 border border-green-500/50 text-green-400 text-xs font-semibold">
                                Vérifié
                            </span>
                        </div>
                    </div>
