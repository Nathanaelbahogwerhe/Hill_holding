    ...
    <div class="bg-hh-card rounded-lg p-6 border border-hh-border">
        ...
        <form method="POST" action="{{ route('admin.system-notifications.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" required class="w-full px-4 py-2 bg-hh-dark border border-hh-border rounded-lg text-hh-light focus:outline-none focus:ring-2 focus:ring-hh-gold @error('title') border-red-500 @enderror" placeholder="Titre de la notification">
                @error('title')
            ...
            <div>
                ...
                <textarea id="message" name="message" rows="4" required class="w-full px-4 py-2 bg-hh-dark border border-hh-border rounded-lg text-hh-light focus:outline-none focus:ring-2 focus:ring-hh-gold @error('message') border-red-500 @enderror" placeholder="Contenu du message...">{{ old('message') }}</textarea>
                @error('message')
                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="datetime-local" id="expires_at" name="expires_at" value="{{ old('expires_at') }}" class="w-full px-4 py-2 bg-hh-dark border border-hh-border rounded-lg text-hh-light focus:outline-none focus:ring-2 focus:ring-hh-gold @error('expires_at') border-red-500 @enderror">
