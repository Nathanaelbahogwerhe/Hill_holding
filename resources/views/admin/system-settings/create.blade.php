    ...
    <div class="bg-hh-card rounded-xl p-6 border border-hh-border">
        ...
        <form method="POST" action="{{ route('admin.system-settings.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="key" name="key" value="{{ old('key') }}" required class="w-full px-4 py-2 bg-hh-dark border border-hh-border rounded-xl text-hh-light focus:outline-none focus:ring-2 focus:ring-hh-gold @error('key') border-red-500 @enderror" placeholder="app_name, maintenance_mode, etc.">
            ...
            <div>
                ...
                <textarea id="value" name="value" rows="3" required class="w-full px-4 py-2 bg-hh-dark border border-hh-border rounded-xl text-hh-light focus:outline-none focus:ring-2 focus:ring-hh-gold @error('value') border-red-500 @enderror">{{ old('value') }}</textarea>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="2" class="w-full px-4 py-2 bg-hh-dark border border-hh-border rounded-xl text-hh-light focus:outline-none focus:ring-2 focus:ring-hh-gold @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                @error('description')
                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
