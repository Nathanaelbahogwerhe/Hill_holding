        ...
        <form method="POST" action="{{ route('admin.backups.create') }}" class="space-y-4">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {{-- Database Backup --}}
                    <label class="relative flex items-center p-4 border-2 border-hh-border rounded-xl cursor-pointer hover:border-hh-gold transition">
            ...
            <div class="pt-4">
                <button type="submit" class="px-6 py-3 bg-hh-gold text-hh-dark rounded-xl hover:bg-hh-gold/90 transition flex items-center gap-2">
                ...
                <tbody class="divide-y divide-hh-border">
                    ...
                    <tr class="hover:bg-hh-dark/30 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <span class="px-2 py-1 text-xs font-medium rounded-full bg-gradient-to-br from-blue-900/50 to-blue-800/50 border border-blue-500/300/20 text-blue-500">
                                Base de données
                            </span>
                            @elseif($backup->type === 'files')
                            <span class="px-2 py-1 text-xs font-medium rounded-full bg-gradient-to-br from-green-900/50 to-green-800/50 border border-green-500/300/20 text-green-500">
                                Fichiers
                            </span>
                            @else
                            <span class="px-2 py-1 text-xs font-medium rounded-full bg-gradient-to-br from-purple-900/50 to-purple-800/50 border border-purple-500/300/20 text-purple-500">
                                Complète
                            </span>
                            @endif
                        </td>
