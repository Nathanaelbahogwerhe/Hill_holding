    ...
    <div class="bg-hh-card rounded-lg p-6 border border-hh-border">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <form method="POST" action="{{ route('admin.cache.clear') }}">
                @csrf
                <button type="submit" class="w-full px-4 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg text-white flex items-center justify-center gap-2 transition">
            ...
            <form method="POST" action="{{ route('admin.system.optimize') }}">
                @csrf
                <button type="submit" class="w-full px-4 py-3 bg-green-600 hover:bg-green-700 rounded-lg text-white flex items-center justify-center gap-2 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                    Optimiser
            ...
            <form method="POST" action="{{ route('admin.system-settings.maintenance.toggle') }}">
                @csrf
                <button type="submit" class="w-full px-4 py-3 bg-orange-600 hover:bg-orange-700 rounded-lg text-white flex items-center justify-center gap-2 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {{-- System Info --}}
            <a href="{{ route('admin.system.info') }}" class="px-4 py-3 bg-purple-600 hover:bg-purple-700 rounded-lg text-white flex items-center justify-center gap-2 transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
