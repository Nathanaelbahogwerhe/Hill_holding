    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-neutral-400">Mettre à jour les informations de couverture</p>
            </div>
        ...
        <form action="{{ route('employee_insurances.update', $insurance->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" value="{{ $insurance->employee?->department?->name ?? '—' }}" class="w-full px-4 py-2 rounded-xl bg-neutral-800 border border-neutral-700 text-neutral-400" disabled>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="start_date" value="{{ $insurance->start_date?->format('Y-m-d') }}" class="w-full px-4 py-2 rounded-xl bg-neutral-800 border border-neutral-700 text-white focus:outline-none focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20 transition-all" required>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="end_date" value="{{ $insurance->end_date?->format('Y-m-d') }}" class="w-full px-4 py-2 rounded-xl bg-neutral-800 border border-neutral-700 text-white focus:outline-none focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20 transition-all">
                </div>
