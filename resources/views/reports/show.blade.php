    ...
    <div class="max-w-5xl mx-auto">
        <div class="bg-gradient-to-br from-neutral-900 to-black border border-neutral-800 rounded-2xl shadow-2xl p-8">
            ...
            <div class="flex justify-between items-start mb-6">
                <div>
                    <h1 class="text-5xl font-bold bg-gradient-to-r from-[#D4AF37] via-yellow-500 to-[#D4AF37] bg-clip-text text-transparent animate-gradient">{{ $report->titre }}</h1>
                    <p class="text-neutral-400">{{ $report->created_at->format('d/m/Y') }}</p>
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="border-b pb-4">
                    <p class="text-sm text-neutral-400 mb-2">Période couverte</p>
                    <p class="font-medium">
                ...
                <!-- Contenu -->
                <div class="border-b pb-4">
                    <p class="text-sm text-neutral-400 mb-2">Contenu</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @if($report->project)
                    <div class="border-b pb-4">
                        <p class="text-sm text-neutral-400 mb-2">Projet</p>
                    ...
                    <div class="border-b pb-4">
                        <p class="text-sm text-neutral-400 mb-2">Département</p>
                    ...
                    @if($report->filiale)
                    <div class="border-b pb-4">
                        <p class="text-sm text-neutral-400 mb-2">Filiale</p>
                    ...
                    @if($report->agence)
                    <div class="border-b pb-4">
                        <p class="text-sm text-neutral-400 mb-2">Agence</p>
                ...
                <!-- Soumetteur -->
                <div class="border-b pb-4">
                    <p class="text-sm text-neutral-400 mb-2">Soumis par</p>
                ...
                <div class="border-b pb-4">
                    ...
                    @if($report->commentaires)
                        <p class="mt-2 text-sm text-[#D4AF37] italic">"{{ $report->commentaires }}"</p>
                    @endif
                </div>
                @endif
