...
<div class="max-w-xl mx-auto bg-hh-card p-6 rounded shadow">
    <h2 class="text-lg font-semibold mb-4">DÃ©tails de l'assurance</h2>
    ...
    <div class="mt-4 space-x-2">
        <a href="{{ route('insurances.edit', $insurance) }}" class="btn btn-secondary">Ã‰diter</a>
        <a href="{{ route('insurances.index') }}" class="btn btn-primary">Retour Ã  la liste</a>
    </div>
</div>
@endsection
