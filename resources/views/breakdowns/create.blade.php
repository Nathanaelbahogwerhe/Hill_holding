...
<div class="max-w-5xl mx-auto">
    <div class="mb-6">
        <h1 class="text-5xl font-bold bg-gradient-to-r from-[#D4AF37] via-yellow-500 to-[#D4AF37] bg-clip-text text-transparent animate-gradient">Signaler une Panne</h1>
        <p class="text-neutral-400">Enregistrer une nouvelle panne d'équipement</p>
    </div>

    <form action="{{ route('breakdowns.store') }}" method="POST" class="bg-white rounded-xl shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Date & Heure de la Panne <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Signalée Par <span class="text-red-500">*</span></label>
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Description de la Panne <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Sévérité <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Impact sur Production</label>
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Cause Probable</label>
