...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Nouvelle Maintenance Véhicule</h1>
        <p class="text-gray-600">Planifier une maintenance de véhicule</p>
    </div>

    <form action="{{ route('vehicle_maintenances.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Type Maintenance <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Kilométrage Planifié</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Garage/Prestataire</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Prochaine Échéance (km)</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Prochaine Échéance (date)</label>
