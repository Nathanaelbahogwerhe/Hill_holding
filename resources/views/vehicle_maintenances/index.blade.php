...
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Maintenances Véhicules</h1>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <a href="{{ route('vehicle_maintenances.show', $maintenance) }}" class="text-blue-600 hover:underline">{{ $maintenance->numero }}</a>
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4">
                        <span class="px-2 py-1 text-xs rounded 
                            ...
                            @elseif($maintenance->statut === 'terminee') bg-green-100 text-green-800
                    ...
                    <td class="px-6 py-4 text-right text-sm">
                        <a href="{{ route('vehicle_maintenances.show', $maintenance) }}" class="text-blue-600 hover:underline">Voir</a>
                    </td>
                </tr>
                @empty
                <tr>
