    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex justify-between items-start mb-6">
                <div>
                    <h1 class="text-2xl font-bold">Rapport du {{ \Carbon\Carbon::parse($dailyOperation->date)->format('d/m/Y') }}</h1>
                    @if($dailyOperation->project)
                        <p class="text-gray-600">Projet: {{ $dailyOperation->project->name }}</p>
                    @endif
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="border-b pb-4">
                    <p class="text-sm text-gray-600 mb-2">Activités Réalisées</p>
                ...
                <div class="border-b pb-4">
                    <p class="text-sm text-gray-600 mb-2">Problèmes Rencontrés</p>
                ...
                <div class="border-b pb-4">
                    <p class="text-sm text-gray-600 mb-2">Solutions Apportées</p>
                ...
                <div class="border-b pb-4">
                    <p class="text-sm text-gray-600 mb-2">Prévisions du Lendemain</p>
                ...
                <div class="border-b pb-4">
                    <p class="text-sm text-gray-600 mb-2">Observations</p>
                    <p class="text-gray-700">{!! nl2br(e($dailyOperation->observations)) !!}</p>
                </div>
                @endif
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="border-b pb-4">
                        <p class="text-sm text-gray-600 mb-1">Nombre de Personnel</p>
                ...
                <!-- Soumetteur -->
                <div class="border-b pb-4">
                    <p class="text-sm text-gray-600 mb-1">Soumis par</p>
