                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="observations" rows="2" 
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2">{{ old('observations', $dailyOperation->observations) }}</textarea>
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Pièces Jointes Actuelles</label>
                        <div class="space-y-2">
                    ...
                    <!-- Nouveaux fichiers -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Ajouter des Pièces Jointes</label>
