...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('products.create') }}" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-bold transition">
             Ajouter
        </a>
    </div>
            ...
            <tbody class="divide-y divide-slate-700">
                @forelse($products as $product)
                    <tr class="hover:bg-slate-800 transition">
                        <td class="px-6 py-4 text-sm text-gray-300">#{{ $product->id }}</td>
                        ...
                        <td class="px-6 py-4 text-right text-sm space-x-2">
                            <a href="{{ route('products.show', $product->id) }}" class="text-blue-400 hover:text-blue-300 font-bold"></a>
                            <a href="{{ route('products.edit', $product->id) }}" class="text-cyan-400 hover:text-cyan-300 font-bold"></a>
