...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-neutral-400 mt-2">Gérez vos services</p>
        </div>
        <a href="{{ route('services.create') }}" class="px-6 py-3 bg-gradient-to-r from-[#D4AF37] to-yellow-500 hover:from-yellow-500 hover:to-[#D4AF37] text-black rounded-xl font-bold transition-all duration-300 shadow-lg hover:shadow-[#D4AF37]/50 flex items-center gap-2">
            ...
            <tbody class="divide-y divide-neutral-700">
                @forelse($services as $service)
                    <tr class="hover:bg-neutral-800/50 transition">
                        <td class="px-6 py-4 text-sm text-neutral-300">#{{ $service->id }}</td>
                        ...
                        <td class="px-6 py-4 text-right text-sm space-x-2">
                            <a href="{{ route('services.show', $service->id) }}" class="text-[#D4AF37] hover:text-yellow-500 font-bold"></a>
                            <a href="{{ route('services.edit', $service->id) }}" class="text-[#D4AF37] hover:text-yellow-500 font-bold"></a>
