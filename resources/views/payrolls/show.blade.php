    ...
    <div class="bg-black rounded-lg shadow-xl p-8 border border-neutral-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div>
                ...
                <a href="{{ Storage::url($payroll->attachment) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-[#D4AF37] hover:bg-yellow-500 text-black rounded-lg font-semibold transition">
        ...
        <div class="flex gap-4 pt-8 border-t border-neutral-700">
            <a href="{{ route('payrolls.edit', $payroll->id) }}" class="px-6 py-3 bg-neutral-700 hover:bg-neutral-600 text-white rounded-lg font-bold transition">✏️ Modifier</a>
