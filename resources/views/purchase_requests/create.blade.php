...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Nouvelle Demande d'Achat</h1>
        <p class="text-gray-600">Créer une demande d'achat pour approbation</p>
    </div>

    <form action="{{ route('purchase_requests.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {{-- Date Nécessité --}}
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Date de Nécessité <span class="text-red-500">*</span></label>
