...
<div class="max-w-5xl mx-auto">
    <div class="mb-6">
        <h1 class="text-5xl font-bold bg-gradient-to-r from-[#D4AF37] via-yellow-500 to-[#D4AF37] bg-clip-text text-transparent animate-gradient">Nouvel Équipement IT</h1>
        <p class="text-neutral-400">Enregistrer un nouvel équipement informatique</p>
    </div>

    <form action="{{ route('it_equipment.store') }}" method="POST" class="bg-white rounded-xl shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Processeur</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">RAM</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Disque Dur</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Système d'Exploitation</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Utilisateur</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Date Attribution</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Date Acquisition</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Prix Acquisition (FCFA)</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">État</label>
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Configuration Détaillée</label>
