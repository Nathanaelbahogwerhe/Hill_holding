...
<div class="max-w-5xl mx-auto">
    <div class="mb-6">
        <h1 class="text-5xl font-bold bg-gradient-to-r from-[#D4AF37] via-yellow-500 to-[#D4AF37] bg-clip-text text-transparent animate-gradient">Nouveau Bon de Commande</h1>
        <p class="text-neutral-400">Créer un bon de commande fournisseur</p>
    </div>

    <form action="{{ route('purchase_orders.store') }}" method="POST" class="bg-white rounded-xl shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Montant HT (FCFA) <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Taux TVA (%)</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Montant TTC (FCFA)</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Date Commande <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Date Livraison Prévue</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Mode de Paiement</label>
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Conditions de Paiement</label>
