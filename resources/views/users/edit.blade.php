@extends('layouts.app')
@section('title', 'Ã‰diter utilisateur')

@section('content')
<div class="max-w-xl mx-auto bg-hh-card p-6 rounded shadow">
    <h2 class="text-lg font-semibold mb-4">Ã‰diter lâ€™utilisateur</h2>
    ...
    <form action="{{ route('users.update', $user) }}" method="POST">
        ...
        <div class="mb-4">
            <label class="block mb-1 font-semibold">Mot de passe (laisser vide pour ne pas changer)</label>
            <input type="password" name="password" class="input input-bordered w-full">
        </div>

        <div class="mb-4">
            <label class="block mb-1 font-semibold">RÃ´le</label>
        ...
        <div class="mb-4">
            ...
            <select name="filiale_id" class="input input-bordered w-full">
