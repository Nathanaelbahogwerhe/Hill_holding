    ...
    <div class="max-w-5xl mx-auto">
        <div class="bg-gradient-to-br from-neutral-900 to-black border border-neutral-800 rounded-2xl shadow-2xl p-8">
            ...
            <div class="flex justify-between items-start mb-6">
                <div>
                    <h1 class="text-5xl font-bold bg-gradient-to-r from-[#D4AF37] via-yellow-500 to-[#D4AF37] bg-clip-text text-transparent animate-gradient">{{ $activity->titre }}</h1>
                    <p class="text-neutral-400">{{ \Carbon\Carbon::parse($activity->date_prevue)->format('d/m/Y') }}</p>
                </div>
            ...
            <div class="mb-6 flex space-x-3">
                @if($activity->type == 'réunion')
                    <span class="px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-blue-900/50 to-blue-800/50 border border-blue-500/30 text-blue-300">Réunion</span>
                @elseif($activity->type == 'formation')
                    <span class="px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-green-900/50 to-green-800/50 border border-green-500/30 text-green-300">Formation</span>
                ...
                @elseif($activity->statut == 'en_cours')
                    <span class="px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-blue-900/50 to-blue-800/50 border border-blue-500/30 text-blue-300">En cours</span>
                @elseif($activity->statut == 'terminée')
                    <span class="px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-green-900/50 to-green-800/50 border border-green-500/30 text-green-300">Terminée</span>
                @else
            ...
            <div class="space-y-6">
                ...
                <div class="border-b pb-4">
                    <p class="text-sm text-neutral-400 mb-2">Description</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="border-b pb-4">
                        <p class="text-sm text-neutral-400 mb-1">Heure Fin</p>
                ...
                @if($activity->lieu)
                <div class="border-b pb-4">
                    <p class="text-sm text-neutral-400 mb-1">Lieu</p>
                ...
                <div class="border-b pb-4">
                    <p class="text-sm text-neutral-400 mb-2">Participants</p>
                    @php
                    ...
                    @if($participants->count() > 0)
                        <div class="flex flex-wrap gap-2">
                            @foreach($participants as $participant)
                                <span class="px-3 py-1 bg-gray-100 text-[#D4AF37] rounded-full text-sm">
                                    {{ $participant->name }}
                                </span>
                            @endforeach
                        </div>
                ...
                <!-- Créateur -->
                <div class="border-b pb-4">
                    <p class="text-sm text-neutral-400 mb-1">Créé par</p>
