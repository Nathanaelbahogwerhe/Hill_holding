        ...
        <div class="bg-gradient-to-br from-neutral-900 to-black border border-neutral-800 rounded-2xl shadow-2xl p-8">
            ...
            <form action="{{ route('report_schedules.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    <!-- Nom -->
                    <div>
                        <label class="block text-sm font-medium text-[#D4AF37] mb-2">Nom du Calendrier *</label>
                    ...
                    <!-- Type de rapport -->
                    <div>
                        <label class="block text-sm font-medium text-[#D4AF37] mb-2">Type de Rapport *</label>
                        <select name="type_rapport" class="w-full bg-neutral-800 border border-neutral-700 rounded-xl px-4 py-3 text-white focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20" required>
                    ...
                    <!-- Fréquence -->
                    <div>
                        <label class="block text-sm font-medium text-[#D4AF37] mb-2">Fréquence *</label>
                        <select name="frequence" id="frequence" class="w-full bg-neutral-800 border border-neutral-700 rounded-xl px-4 py-3 text-white focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20" required>
                            <option value="">Sélectionner</option>
                    ...
                    <div id="jour_semaine_div" style="display: none;">
                        <label class="block text-sm font-medium text-[#D4AF37] mb-2">Jour de la Semaine</label>
                        <select name="jour_semaine" class="w-full bg-neutral-800 border border-neutral-700 rounded-xl px-4 py-3 text-white focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20">
                            <option value="">Sélectionner</option>
                    ...
                    <div id="jour_mois_div" style="display: none;">
                        <label class="block text-sm font-medium text-[#D4AF37] mb-2">Jour du Mois (1-31)</label>
                    ...
                    <!-- Heure d'échéance -->
                    <div>
                        <label class="block text-sm font-medium text-[#D4AF37] mb-2">Heure d'Échéance</label>
                    ...
                    <div>
                        ...
                        <select name="department_id" class="w-full bg-neutral-800 border border-neutral-700 rounded-xl px-4 py-3 text-white focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20" required>
                            <option value="">Sélectionner</option>
                    ...
                    <!-- Responsable -->
                    <div>
                        <label class="block text-sm font-medium text-[#D4AF37] mb-2">Responsable</label>
                        <select name="responsable_id" class="w-full bg-neutral-800 border border-neutral-700 rounded-xl px-4 py-3 text-white focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20">
                            <option value="">Sélectionner</option>
                    ...
                    <div>
                        <label class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-[#D4AF37]">Calendrier actif</span>
                        </label>
                    </div>
                </div>
