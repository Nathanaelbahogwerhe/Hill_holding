...
@section('title', 'Cr̩er un d̩partement')

@section('content')
<div class="max-w-xl mx-auto bg-hh-card p-6 rounded shadow">
    <h2 class="text-lg font-semibold mb-4">Cr̩er un d̩partement</h2>
    ...
    <form action="{{ route('departments.store') }}" method="POST">
        ...
        {{-- S̩lection de la filiale (Super Admin uniquement) --}}
        @role('Super Admin')
            <div class="mb-4">
        ...
        <div class="flex justify-end mt-6 space-x-2">
            <a href="{{ route('departments.index') }}" class="btn btn-ghost">Annuler</a>
