...
<div class="px-6 py-6">
    ...
    <div class="mb-8">
        ...
        <p class="text-neutral-400">Organisez et gérez les départements de votre entreprise</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-neutral-900 to-black border border-neutral-800 rounded-2xl p-6 shadow-2xl hover:scale-105 transition-transform duration-300">
            ...
            <div class="text-neutral-400 text-sm">Total des départements</div>
        </div>
                    ...
                    <tr class="hover:bg-neutral-800/50 transition-colors duration-200">
                        <td class="p-4">
                            <div class="flex items-center gap-3">
                                <div class="p-2 bg-gradient-to-r from-purple-600/30 to-purple-700/30 border border-purple-500/50 rounded-xl">
                                    <svg class="w-6 h-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                    </svg>
                                </div>
                                <div>
                                    <div class="text-white font-semibold">{{ $dept->name }}</div>
                                    <div class="text-xs text-neutral-400">ID: #{{ $dept->id }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="p-4">
                        ...
                        <td class="p-4">
                            <div class="inline-flex items-center gap-2 px-3 py-1 bg-neutral-800 rounded-xl">
                                ...
                                <span class="text-white font-semibold">{{ $dept->employees->count() }}</span>
                    ...
                    <tr>
                        <td colspan="5" class="px-4 py-16 text-center">
                            <div class="flex flex-col items-center gap-4">
                                ...
                                <div class="text-neutral-400 text-lg">Aucun département trouvé</div>
                                <a href="{{ route('departments.create') }}"
