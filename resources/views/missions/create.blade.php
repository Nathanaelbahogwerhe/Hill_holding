...
<div class="max-w-5xl mx-auto">
    <div class="mb-6">
        <h1 class="text-5xl font-bold bg-gradient-to-r from-[#D4AF37] via-yellow-500 to-[#D4AF37] bg-clip-text text-transparent animate-gradient">Nouvelle Mission</h1>
        <p class="text-neutral-400">Planifier une nouvelle mission de déplacement</p>
    </div>

    <form action="{{ route('missions.store') }}" method="POST" class="bg-white rounded-xl shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {{-- Conducteur --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Conducteur <span class="text-red-500">*</span></label>
            ...
            {{-- Demandeur --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Demandeur <span class="text-red-500">*</span></label>
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Destination <span class="text-red-500">*</span></label>
            ...
            {{-- Motif --}}
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Motif <span class="text-red-500">*</span></label>
            ...
            {{-- Date Début --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Date & Heure Début <span class="text-red-500">*</span></label>
            ...
            {{-- Date Fin Prévue --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Date & Heure Fin Prévue</label>
            ...
            {{-- Distance Estimée --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Distance Estimée (km)</label>
            ...
            {{-- Kilométrage Départ --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Kilométrage Départ</label>
            ...
            {{-- Passagers --}}
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Passagers (JSON)</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Montant Carburant Prévu (FCFA)</label>
            ...
            {{-- Autres Frais --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Autres Frais (FCFA)</label>
