...
<div class="max-w-5xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold">Mission {{ $mission->numero }}</h1>
            <p class="text-gray-600">{{ $mission->destination }}</p>
        </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <p class="text-sm text-gray-600">Conducteur</p>
                    ...
                    <div>
                        <p class="text-sm text-gray-600">Date Fin Prévue</p>
                        <p class="font-medium">{{ $mission->date_fin_prevue->format('d/m/Y H:i') }}</p>
                    </div>
                    @endif
                    @if($mission->date_fin_reelle)
                    <div>
                        <p class="text-sm text-gray-600">Date Fin Réelle</p>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        <p class="text-sm text-gray-600 font-medium">Passagers</p>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        <span class="text-sm text-gray-600">Autres Frais</span>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="text-center">
                    <span class="inline-block px-4 py-2 text-sm font-semibold rounded 
                        @if($mission->statut === 'planifiee') bg-blue-100 text-blue-800
                        @elseif($mission->statut === 'en_cours') bg-green-100 text-green-800
