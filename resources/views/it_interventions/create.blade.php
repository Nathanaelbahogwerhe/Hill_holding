...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Nouvelle Demande Support IT</h1>
        <p class="text-gray-600">Créer une demande d'intervention technique</p>
    </div>

    <form action="{{ route('it_interventions.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
