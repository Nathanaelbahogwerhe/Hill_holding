...
<div class="max-w-5xl mx-auto">
    <div class="mb-6">
        <h1 class="text-5xl font-bold bg-gradient-to-r from-[#D4AF37] via-yellow-500 to-[#D4AF37] bg-clip-text text-transparent animate-gradient">Nouveau Véhicule</h1>
        <p class="text-neutral-400">Enregistrer un nouveau véhicule dans la flotte</p>
    </div>

    <form action="{{ route('vehicles.store') }}" method="POST" class="bg-white rounded-xl shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {{-- Immatriculation --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Immatriculation <span class="text-red-500">*</span></label>
            ...
            {{-- Marque --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Marque <span class="text-red-500">*</span></label>
            ...
            {{-- Modèle --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Modèle <span class="text-red-500">*</span></label>
            ...
            {{-- Année --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Année</label>
            ...
            {{-- Couleur --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Couleur</label>
            ...
            {{-- Numéro de Châssis --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Numéro de Châssis</label>
            ...
            {{-- Kilométrage Initial --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Kilométrage Initial</label>
            ...
            {{-- Capacité Carburant --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Capacité Réservoir (L)</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Consommation Moyenne (L/100km)</label>
            ...
            {{-- Chauffeur --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Chauffeur Attitré</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Date Début Assurance</label>
            ...
            {{-- Date Fin Assurance --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Date Fin Assurance</label>
            ...
            {{-- Compagnie Assurance --}}
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Compagnie d'Assurance</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Date Visite Technique</label>
