...
<div class="max-w-5xl mx-auto">
    <div class="mb-6">
        <h1 class="text-5xl font-bold bg-gradient-to-r from-[#D4AF37] via-yellow-500 to-[#D4AF37] bg-clip-text text-transparent animate-gradient">Nouvelle Intervention</h1>
        <p class="text-neutral-400">Enregistrer une intervention technique</p>
    </div>

    <form action="{{ route('interventions.store') }}" method="POST" class="bg-white rounded-xl shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Liée à une Panne</label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Technicien <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Date Intervention <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Durée (heures)</label>
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Actions Réalisées</label>
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-[#D4AF37] mb-1">Pièces Utilisées</label>
