...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Nouveau Contrat Fournisseur</h1>
        <p class="text-gray-600">Enregistrer un contrat avec un fournisseur</p>
    </div>

    <form action="{{ route('supplier_contracts.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Fréquence Paiement</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Renouvellement Automatique</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Préavis Résiliation (jours)</label>
