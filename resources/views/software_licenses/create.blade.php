...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Nouvelle Licence Logiciel</h1>
        <p class="text-gray-600">Enregistrer une nouvelle licence</p>
    </div>

    <form action="{{ route('software_licenses.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Nom Logiciel <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Type Licence <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Numéro Licence</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Clé Activation</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Nombre Postes <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Postes Utilisés</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Date Achat</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Période Facturation</label>
