...
@section('content')
<h1 class="text-xl font-semibold mb-4">Ajouter un poste</h1>
...
<form action="{{ route('positions.store') }}" method="POST" class="space-y-4 bg-hh-card p-4 rounded-lg shadow-sm">
    @csrf
    <div>
