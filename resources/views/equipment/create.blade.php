...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Nouvel Équipement</h1>
        <p class="text-gray-600">Enregistrer un nouvel équipement dans l'inventaire</p>
    </div>

    <form action="{{ route('equipment.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {{-- Prix d'Acquisition --}}
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Prix d'Acquisition (FCFA)</label>
            ...
            {{-- Durée Vie Estimée --}}
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Durée de Vie Estimée (années)</label>
            ...
            {{-- Affectation --}}
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Affecté à</label>
