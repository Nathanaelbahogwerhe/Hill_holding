...
<div class="max-w-6xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold">{{ $equipment->nom }} <span class="text-gray-500 font-mono">{{ $equipment->code }}</span></h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <p class="text-sm text-gray-600">N° Série</p>
                    ...
                    <div>
                        <p class="text-sm text-gray-600">Affecté à</p>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <p class="text-sm text-gray-600">Date d'Acquisition</p>
                        <p class="font-medium">{{ $equipment->date_acquisition->format('d/m/Y') }}</p>
                    </div>
                    @if($equipment->prix_acquisition)
                    <div>
                        <p class="text-sm text-gray-600">Prix d'Acquisition</p>
                        <p class="font-bold text-lg">{{ number_format($equipment->prix_acquisition, 0, ',', ' ') }} FCFA</p>
                    </div>
                    @endif
                    @if($equipment->date_fin_garantie)
                    <div>
                        <p class="text-sm text-gray-600">Fin Garantie</p>
                        <p class="font-medium {{ $equipment->is_garantie_active ? 'text-green-600' : 'text-red-600' }}">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <span class="text-sm text-gray-600">{{ $equipment->maintenances->count() }} maintenances</span>
                </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <span class="text-sm text-gray-600">{{ $equipment->breakdowns->count() }} pannes</span>
                </div>
                <div class="space-y-3">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="text-center">
                    <span class="inline-block px-4 py-2 text-sm font-semibold rounded 
                        @if($equipment->statut === 'en_service') bg-green-100 text-green-800
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="text-center">
                    <p class="text-2xl font-bold {{ $equipment->maintenance_due ? 'text-red-600' : 'text-blue-600' }}">
                    ...
                    @else
                    <p class="text-sm text-gray-600 mt-2">Dans {{ now()->diffInDays($equipment->date_prochaine_maintenance) }} jours</p>
                    @endif
                </div>
            </div>
            @endif
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        <span class="text-sm text-gray-600">Interventions</span>
                        <span class="font-medium">{{ $equipment->interventions->count() }}</span>
                    </div>
                    @if($equipment->prix_acquisition)
                    <div class="flex justify-between pt-3 border-t">
                        <span class="text-sm text-gray-600">Coût Total Maint.</span>
