...
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-5xl font-bold bg-gradient-to-r from-[#D4AF37] via-yellow-500 to-[#D4AF37] bg-clip-text text-transparent animate-gradient">Équipements</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white p-4 rounded-xl shadow">
            <p class="text-sm text-neutral-400">En Service</p>
            <p class="text-2xl font-bold text-white">{{ $stats['en_service'] ?? 0 }}</p>
        </div>
        <div class="bg-white p-4 rounded-xl shadow">
        ...
        <div class="bg-white p-4 rounded-xl shadow">
            <p class="text-sm text-neutral-400">Hors Service</p>
            <p class="text-2xl font-bold text-red-600">{{ $stats['hors_service'] ?? 0 }}</p>
        </div>
        <div class="bg-white p-4 rounded-xl shadow">
            <p class="text-sm text-neutral-400">Maint. à Planifier</p>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <a href="{{ route('equipment.show', $item) }}" class="text-white hover:underline font-mono">{{ $item->code }}</a>
                    </td>
                    <td class="px-6 py-4">
                        <div>
                    ...
                    <td class="px-6 py-4">
                        <span class="px-2 py-1 text-xs rounded 
                            @if($item->statut === 'en_service') bg-gradient-to-r from-green-900/50 to-green-800/50 border border-green-500/30 text-green-300
                    ...
                    <td class="px-6 py-4 text-right text-sm">
                        <a href="{{ route('equipment.show', $item) }}" class="text-white hover:underline mr-3">Voir</a>
