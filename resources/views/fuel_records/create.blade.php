...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Nouveau Ravitaillement</h1>
        <p class="text-gray-600">Enregistrer un ravitaillement en carburant</p>
    </div>

    <form action="{{ route('fuel_records.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Date Ravitaillement <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Conducteur</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Quantité (Litres) <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Kilométrage <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Kilométrage Précédent</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Consommation (L/100km)</label>
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-1">Station Service</label>
