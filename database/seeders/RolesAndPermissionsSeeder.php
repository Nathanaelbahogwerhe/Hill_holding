...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run()
    {
        // ðŸ”¹ Reset roles and permissions
        ...
        // -------------------------
        // 1ï¸âƒ£ DÃ©finir les permissions
        // -------------------------
        $permissions = [
            // RH
        ...
        $roles = [
            ...
            'Operations Manager' => Permission::where('name', 'like', '%clients%')
                                ...
                                ->get(),
            'Employee'         => Permission::where('name', 'like', '%edit_profile%')
                                ->get(),
        ];
        ...
        // -------------------------
        // 3ï¸âƒ£ CrÃ©er utilisateurs de test
        // -------------------------
        $users = [
            ['name' => 'Super Admin', 'email' => 'admin@hillholding.bi', 'password' => bcrypt('password123'), 'role' => 'Super Admin'],
            ['name' => 'RH Manager', 'email' => 'hr@hillholding.bi', 'password' => bcrypt('password123'), 'role' => 'RH Manager'],
