    ...
    public function run(): void
    {
        $assets = [
            ...
            [
                ...
                'status' => 'active',
                'description' => 'Bureau en bois pour les employÃ©s',
            ],
            [
                ...
                'acquisition_date' => now()->subYears(1),
                'status' => 'active',
                'description' => 'Chaise ergonomique pour le confort des employÃ©s',
            ],
            [
                'name' => 'Projecteur Epson',
                'category' => 'Ã‰quipement audiovisuel',
                'value' => 800,
                'quantity' => 3,
                'acquisition_date' => now()->subMonths(8),
                'status' => 'active',
                'description' => 'Projecteur pour les prÃ©sentations en salle de rÃ©union',
            ],
            [
                'name' => 'Table de confÃ©rence',
                'category' => 'Mobilier',
                'value' => 600,
                'quantity' => 2,
                'acquisition_date' => now()->subYears(2),
                'status' => 'active',
                'description' => 'Grande table pour les rÃ©unions d\'Ã©quipe',
            ],
            [
                ...
                'status' => 'active',
                'description' => 'Serveur de stockage en rÃ©seau pour les donnÃ©es de l\'entreprise',
            ],
            [
                ...
                'status' => 'active',
                'description' => 'TÃ©lÃ©phone IP pour les communications internes et externes',
            ],
            [
                'name' => 'Tablette iPad',
                'category' => 'Informatique',
                ...
                'status' => 'active',
                'description' => 'Tablette pour les prÃ©sentations mobiles et la prise de notes',
            ],
            [
                ...
                'status' => 'active',
                'description' => 'CamÃ©ra pour la surveillance des locaux',
            ],
        ];
