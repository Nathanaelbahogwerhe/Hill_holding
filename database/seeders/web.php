...
Route::middleware(['auth'])->group(function () {
    ...
    // Page d'accueil / dashboard (utilise HomeController)
    ...
    */
    ...
    /*
    |----------------------------------------------------------------------
    | Business (Super Admin, ChargÃ© des OpÃ©rations, Operations Manager)
    |----------------------------------------------------------------------
    */
    ...
    */
    ...
    /*
    |----------------------------------------------------------------------
    | Outils (accessible Ã  tous les utilisateurs authentifiÃ©s)
    |----------------------------------------------------------------------
    */
